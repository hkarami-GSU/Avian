...
lambda_vec_1 = [0.05,0.1,0.13,0.2,0.34,0.5,0.7,1,1.4];
lambda_vec_2 = [0.05,0.1,0.11,0.2,0.35,0.45,0.6,0.8,1];
lambda_vec_3 = [0.4,0.9,2,3.3,4.5,6.2,8,10.5,15];
...
Iw_data_all = readtable('wildbird_Iw_MN_all.xlsx');
I0_p = [1; 1; 5];
...
% Get time-dependent beta values for each time point using spline interpolation
