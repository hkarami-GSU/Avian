...
lambda_vec_1 = [0.03,0.08,0.21,0.34,0.44,0.55,0.73,0.93,1.30];
lambda_vec_2 = [0.04,0.09,0.11,0.16,0.22,0.29,0.34,0.40,0.47];
lambda_vec_3 = [0.15,0.30,0.60,1.00,1.40,2.00,2.90,3.60,4.50];
